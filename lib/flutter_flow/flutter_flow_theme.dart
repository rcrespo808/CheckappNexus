...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFF74D1E);
  Color secondaryColor = const Color(0xFFDDDDDD);
  Color tertiaryColor = const Color(0xFF737E7F);
...
class DarkModeTheme extends FlutterFlowTheme {
  ...
  Color tertiaryColor = const Color(0xFF101414);
  Color alternate = const Color(0xFFFF5963);
